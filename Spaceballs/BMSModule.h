...
class BMSModule
{
  public:
    BMSModule();
    void decodevwcan(int Id,  BMS_CAN_MESSAGE &msg);
    void decodebmwcan(int Id, BMS_CAN_MESSAGE &msg);
    void decodevwtemp(BMS_CAN_MESSAGE &msg);
    void decodebmwtemp(BMS_CAN_MESSAGE &msg, int CSC);
    void clearmodule();
    int getscells();
