...
class BMSModuleManager
{
  public:
    ...
    int seriescells();
    void clearmodules();
    void decodevwcan(BMS_CAN_MESSAGE &msg, int debug);
    void decodevwtemp(BMS_CAN_MESSAGE &msg, int debug);
    void decodebmwcan(BMS_CAN_MESSAGE &msg, int debug);
    void decodebmwtemp(BMS_CAN_MESSAGE &msg, int debug, int CSC);
    void getAllVoltTemp();
    void readSetpoints();
